...
const testimonials = [
  ...
  },
  {
    ...
    image: "./src/img/east-west.png",
  },
  {
    name: "Rajan Sharma",
    company: "DR Taxi darta",
    quote:
        ...
        {testimonials.map((testimonial, index) => (
          <div key={index} className="px-2">
            <Card className="rounded-lg shadow-md overflow-hidden h-full flex flex-col justify-between">
              ...
              <p className="mt-4 text-gray-700 text-center px-4 font-medium">{testimonial.quote}</p>
            </Card>
          </div>
        ))}
      </Slider>
