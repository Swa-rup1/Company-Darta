...
const ShareTransfer = React.lazy(() =>
  import("../Dashboard/utils/Services/ShareTransfer")
);

const CompanyClose = React.lazy(() =>
  import("../Dashboard/utils/Services/CompanyClose")
);

const CompanyUpdate = React.lazy(() =>
  import("../Dashboard/utils/Services/CompanyUpdate")
);

const NewCompanyRegistration = React.lazy(() =>
  import("../Dashboard/utils/Services/NewCompanyRegistration")
);
    ...
    <>
      <Route>
        <Route path="/" element={<UserLayout></UserLayout>}>
          ...
          <Route
            path="/service1"
            element={<NewCompanyRegistration title="New Company Registration" />}
          ></Route>
          <Route
            path="/service2"
            element={<CompanyUpdate title="CompanyUpdate" />}
          ></Route>
          <Route
            path="/service3"
            element={<ShareTransfer title="ShareTransfer" />}
          ></Route>
          <Route
            path="/service4"
            element={<CompanyClose title="CompanyClose" />}
          ></Route>
