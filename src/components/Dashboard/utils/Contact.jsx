  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row    justify-evenly  mt-4 ">
        <Card hoverable className=" lg:w-[60%] bg-[#FDE36E]  border border-gray-300 rounded-lg p-4 sm:mr-4 mb-4">
        ...
        <Card  hoverable className="  border border-[#ecf4ed]-300 rounded-lg p-4 sm:ml-4 mb-4">
