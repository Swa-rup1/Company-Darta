      ...
      <div className="mt-8 mb-16">
        ...
        <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4">
          {industries.map((industry) => (
            <div
              key={industry.key}
              className="p-6  bg-gray-200 rounded-lg shadow-md hover:shadow-lg  cursor-pointer  transform hover:scale-105 transition duration-300 flex flex-col items-center justify-center"
            >
